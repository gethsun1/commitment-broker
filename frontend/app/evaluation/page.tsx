...
export default function EvaluationPage() {
      ...
      <div className="min-h-screen bg-background py-12">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <p className="text-xl text-muted-foreground">
            Please select a commitment to view evaluation metrics.
          </p>
        </div>
      </div>
    );
  ...
  const behavioralRecovery = snapshot?.behavioral_recovery_score || {
    score: evaluation?.behavioral_recovery_score || 0,
      ...
      <div className="container mx-auto px-4 max-w-6xl space-y-10">
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              <p className="text-muted-foreground mb-4">
                No evaluation data available for this commitment.
              </p>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {/* Behavioral Recovery Score - Primary Metric */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              <Card>
                ...
                <CardContent>
                  <MetricStat
                    label=""
                    value={
                      evaluation.intervention_success_rate !== undefined
              ...
              <Card>
                ...
                <CardContent>
                  <MetricStat
                    ...
                    description={`${evaluation.false_positive_interventions} false positive${evaluation.false_positive_interventions !== 1 ? "s" : ""} detected`}
                  />
                </CardContent>
              </Card>
            </motion.div>
